...
CREATE TABLE public.admin_notifications (
  ...
  CONSTRAINT admin_notifications_target_user_id_fkey FOREIGN KEY (target_user_id) REFERENCES auth.users(id)
);
...
CREATE TABLE public.record (
  ...
  intermediary_profile_id uuid,
  CONSTRAINT record_pkey PRIMARY KEY (id),
  CONSTRAINT record_policy_id_fkey FOREIGN KEY (policy_id) REFERENCES public.policy(policy_id),
  CONSTRAINT fk_record_intermediary FOREIGN KEY (intermediary_profile_id) REFERENCES public.profiles(id)
);
